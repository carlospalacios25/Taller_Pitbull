<div class="container is-fluid mb-6">
    ...
    if ($id != $_SESSION['id']) { 
    ?>
        <h1 class="title">Cerrar Servicio</h1>
    <?php }else{ ?>
        <h1 class="title">Servicio Ya Cerrado</h1>
    <?php } ?>
...
<div class="container pb-6 pt-6">
    ...
    ?>
        <form class="FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/serviceAjax.php" method="POST" autocomplete="off">
            <input type="hidden" name="Modulo_Servicio" value="cerrarSevicio">
        ...
        <div>
            ...
            <div class="columns">
                ...
                <div class="column">
                <div class="control">
                        <label>Especifique Intervencion</label>
                        <input class="input" type="text" name="mantenimiento" maxlength="1000" 
                                value="<?php echo isset($datos['mantenimiento']) ? $datos['mantenimiento'] : ''; ?>" required>
                    </div>
                </div>
            </div>
