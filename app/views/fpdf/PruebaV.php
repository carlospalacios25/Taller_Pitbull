...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(110, 15, utf8_decode('Pitbull Bikers'), 1, 1, 'C', 0); // AnchoCelda,AltoCelda,titulo,borde(1-0),saltoLinea(1-0),posicion(L-C-R),ColorFondo(1-0)
      ...
      $this->Cell(110);  // mover a la derecha
      $this->SetFont('Arial', 'B', 10);
      $this->Cell(59, 10, utf8_decode("Teléfono : 314 370 5419"), 0, 0, '', 0);
      $this->Ln(5);

      /* COREEO */
      $this->Cell(110);  // mover a la derecha
      $this->SetFont('Arial', 'B', 10);
      $this->Cell(85, 10, utf8_decode("Correo : gutiemario291@gmail.com"), 0, 0, '', 0);
      $this->Ln(5);
      ...
      $this->Cell(100, 10, utf8_decode("INFORMACION PROVEEDORES "), 0, 1, 'C', 0);
      $this->Ln(7);
